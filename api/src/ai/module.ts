...
const nikkatext = path.join(__dirname, './instructs/nikkaGPT.txt');
...
export async function nikkaTextModule(message: string, jid: string, options: NikkaOptions = {}, metadata: string): Promise<string> {
